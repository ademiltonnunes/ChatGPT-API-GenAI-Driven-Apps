...
Furthermore, I subjected the system to several test cases and evaluate the system's behavior in all these cases (This procedure are in evaluation.py file). The system behaved well, despite having to change prompts in some examples. The system generated a different response from a human agent, when compared to responses given by the system and by a human agent.
